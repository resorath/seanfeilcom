<div class="container" id="resume-container">
      ...
      <div id="employmenthistory" class="resume-table">
        ...
        <div id="peoplesoftdeveloper" class="employmentjob">
          ...
          <div class="row">
            ...
            <div class="col-sm-3">
              <p class="resume-date">January 2015 - Current</p>
            </div>
          </div>
         ...
         <div id="peoplesoftdeveloper" class="employmentjob">
          ...
          <div class="row">
            <div class="col-sm-9">
              <p class="resume-title">PeopleSoft Developer: Portal, Integrations, and Security, Product Development</p>
            </div>

            <div class="col-sm-3">
              <p class="resume-date">April 2014 - January 2015</p>
            </div>
          </div>
          ...
          <ul>
            <li>Responsible for the PeopleSoft Portal Implementation, as well as integrations and security across all PeopleSoft applications, learning important skills in ERP development and identity management.</li>
            <li>Planned and implemented numerous corrections and improvements to identity management systems including; Decommissioning of legacy applications, alignment of personal information consistency, correcting flaws in existing infrastructure, and custom development to support new infrastructure. These duties closely aligned with business demands as well as proactively improving IT’s ability to provide core services.</li>
          </ul>
        </div>

        <div id="teamlead" class="employmentjob">
          ...
          <div class="row">
            ...
            <div class="col-sm-3">
              <p class="resume-date">February 2013 - April 2014</p>
            </div>
          </div>
        ...
        <div id="softwaredeveloper" class="employmentjob">
          ...
          <div class="row">
            ...
            <div class="col-sm-3">
              <p class="resume-date">December 2011 - April 2014</p>
            </div>
          </div>
        ...
        <div id="analyst" class="employmentjob">
        ...
        <div id="itsc" class="employmentjob">
      ...
      <div id="education" class="resume-table">
        ...
        <div id="ps">
          ...
          <div class="row">
            ...
            <div class="col-sm-3">
              <p class="resume-date">May 2014</p>
            </div>
          </div>
        ...
        <div id="itil">
          ...
          <p class="resume-education-leader">ITIL</p>
          <div class="row">
            <div class="col-sm-9">
              <p class="resume-education-title">ITIL Foundations, Version 3</p>
            </div>

            <div class="col-sm-3">
              <p class="resume-date">November 2012</p>
            </div>
          </div>
